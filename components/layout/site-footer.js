...
export default function SiteFooter() {
  return (
    <footer className="bg-primary/90 text-white/90 pt-16 pb-8">
    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
      ...
      <div>
        ...
        <ul className="space-y-2 text-sm font-semibold">
          <li>
            <Link href="/services#maintenance" className="text-white/90 hover:text-white transition-colors">
      ...
      <div>
        ...
        <ul className="space-y-4 text-sm font-semibold">
          ...
          <li className="flex items-center">
            ...
            <a href="tel:+6281317069977" className="text-white/90 hover:text-white transition-colors">
              (+62) 813-1706-9977
            </a>
          </li>
          <li className="flex items-center">
            <Mail className="h-5 w-5 text-white mr-2" />
            <a href="mailto:pancatiarasentrausaha@gmail.com" className="text-white/90 hover:text-white transition-colors">
